...
import utilitats.Ordenable;
import utilitats.AlgorismesHash;



/** Facilita la gestió de dates.*/
public class Data03 implements Ordenable {
...
// if (anyTraspas(xAny)==false && xDia>28) return false;
    ...
    public Data03(int xdia, int xmes, int xany) {
    ...
    false: si el canvi no s'ha pogut dur a terme
     */
    public boolean setData03(int nouDia, int nouMes, int nouAny) {
     ...
     */
    public Data03 sumDies(int nreDies) {
        ...
        return new Data03(xdia, xmes, xany);
    }
...
// No caldria this.comparar(d) --- comparar(d)
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Data03) {
            return this.comparar((Data03) obj) == 0;
        }
        return false;
    }
    ...
    public static void main(String args[]) {
        Data03 d1 = new Data03();
        Data03 d2 = new Data03(10, 3, 2006);
        Data03 d3 = new Data03(d2);
        Data03 d4 = new Data03(31, 12, 2020);
